<template>
  <div align="center" class="userLogin">
    <meta charset="UTF-8" />
    ...
    <div id="app" class="container">
      <div class="forms-container">
        <div class="signin-signup">
          <el-form :model="formLogin" class="sign-in-form" status-icon>
            ...
            <div class="input-field">
              <div class="inner_input">
                <el-form-item name="userPassword" prop="userPassword">
                  <el-input
          ...
          <el-form :model="formRegister" class="sign-up-form" status-icon>
...
const handleSubmitLogin = async () => {
  const res = await UserControllerService.userLoginUsingPost(formLogin);
  if (res.code === 0) {
